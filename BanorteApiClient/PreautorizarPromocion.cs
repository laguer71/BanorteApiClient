...
{
   class PreautorizarPromocion
   {
      public string tipoDeOperacion { get { return "preautorizar-promocion"; } }
      ...
      public class Datos
      {
         ...
         public string subAfiliacion { set; get; } = "";
      ...
      public static PreautorizarPromocion CrearBody()
      {
         return new PreautorizarPromocion()
         {
            datos = new Datos()
            {

               idTerminal = "string-1-15",
               importeTotal = 99999999999.99m,
               modoVenta = "ABC",
               ...
               estatusFraude3D = 123,
               eci = new Eci() { codigoSeguridad = "AB" },
               diferimientoInicial = 12,
               numeroPagos = 12,
               tipoPlanPagos = 12,
